...
public class OptimizationConfUtil {
    ...
    public static PhysicalOptimizationConfig createPhysicalOptimizationConf(CompilerProperties compilerProperties,
        ...
        boolean seqBuild = getSeqBuild(compilerProperties, querySpecificConfig);
        ...
        physOptConf.setSeqBuild(seqBuild);
        return physOptConf;
    }

    public static boolean getSeqBuild(CompilerProperties compilerProperties, Map<String, Object> querySpecificConfig) {

        String valueInQuery = (String) querySpecificConfig.get(CompilerProperties.COMPILER_SEQBUILD_KEY);
        if (valueInQuery != null) {
            return OptionTypes.BOOLEAN.parse(valueInQuery);
        }
        return compilerProperties.getSeqBuild();
