...
public class CompilerProperties extends AbstractProperties {
    ...
    public enum Option implements IOption {
        COMPILER_SEQBUILD(BOOLEAN, false, "Sequential Builds for multi-join queries."),
        COMPILER_SORTMEMORY(
                LONG_BYTE_UNIT,
    ...
    public static final String COMPILER_SEQBUILD_KEY = Option.COMPILER_SEQBUILD.ini();
    ...
    public boolean getSeqBuild() {
        return accessor.getBoolean(Option.COMPILER_SEQBUILD);
    }
}
