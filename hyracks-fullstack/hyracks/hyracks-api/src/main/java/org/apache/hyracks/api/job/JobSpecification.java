...
public class JobSpecification implements Serializable, IOperatorDescriptorRegistry, IConnectorDescriptorRegistry {
    ...
    private final Map<IOperatorDescriptor, ArrayList<IOperatorDescriptor>> tempToJoinBlockingMap;

    private final Map<IOperatorDescriptor, ArrayList<IOperatorDescriptor>> seqBuildBlockedToBlockers;
    ...
    public JobSpecification(int frameSize) {
        ...
        tempToJoinBlockingMap = new HashMap<>();
        seqBuildBlockedToBlockers = new HashMap<>();
        opMap = new HashMap<>();
        connMap = new HashMap<>();
    ...
    public void addTempToNextJoinsControlDependency(IOperatorDescriptor temp, ArrayList<IOperatorDescriptor> joins) {
        tempToJoinBlockingMap.put(temp, joins);
    }

    public void addSeqBuildControlDependency(IOperatorDescriptor blocked, ArrayList<IOperatorDescriptor> blockers) {
    ...
    public Map<IOperatorDescriptor, ArrayList<IOperatorDescriptor>> getTempToJoinBlockingMap() {
        return tempToJoinBlockingMap;
    }

    public Map<IOperatorDescriptor, ArrayList<IOperatorDescriptor>> getSeqBuildBlockedToBlockers() {
        return seqBuildBlockedToBlockers;
    }
