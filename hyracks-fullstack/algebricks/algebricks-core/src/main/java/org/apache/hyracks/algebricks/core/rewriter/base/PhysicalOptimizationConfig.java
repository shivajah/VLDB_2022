...
public class PhysicalOptimizationConfig {
    ...
    private static final String MIN_BUILD_PARTITIONS = "MIN_BUILD_PARTITIONS";
    ...
    private static final String SEQ_BUILD = "SEQ_BUILD";
    ...
    public boolean getSeqBuild() {
        return getBoolean(SEQ_BUILD, false);
    }

    public void setSeqBuild(boolean seqb) {
        setBoolean(SEQ_BUILD, seqb);
    }
    ...
    public int getMaxFramesForJoin(long userSpecifiedMemory) {
        ...
        int frameSize = getFrameSize();
        return (int) (userSpecifiedMemory * MB / frameSize);
    }

    public int getBuildPartition(int userSpecifiedValue) {//number of build partitions.One frame per partition.
        setInt(MIN_BUILD_PARTITIONS, userSpecifiedValue);
        return getInt(MIN_BUILD_PARTITIONS, 0);
    }
